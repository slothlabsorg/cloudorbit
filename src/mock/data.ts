...
export const mockSessions: Session[] = [
  {
    ...
    profileName: '123456789012-Admin', method: 'sso', environment: 'prod', isFavorite: true,
  ...
  },
  {
    ...
    profileName: '234567890123-Developer', method: 'federated', environment: 'staging', isFavorite: false,
  ...
  },
  {
    ...
    profileName: '345678901234-ReadOnly', method: 'chained', environment: 'dev', isFavorite: false,
  },
  {
    ...
    profileName: '456789012345-Engineer', method: 'iam', environment: 'sandbox', isFavorite: false,
  },
]
